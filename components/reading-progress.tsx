...
export const ReadingProgress = (): React.JSX.Element => {
  ...
  useEffect(() => {
     ...
     * if the outgoing page was already at the top, the router's scroll reset
     * moves nothing and therefore fires no scroll event, leaving the previous
     * route's progress on screen. Re-running on pathname change covers that;
     * observing the document covers the slower half, where a route's real
     * height only arrives as its images decode.
     */
