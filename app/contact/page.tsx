      ...
      <div className="max-w-[1024px] mx-auto px-5 pt-24 pb-6 sm:pb-8 flex flex-col gap-6 sm:gap-8">
        <div className="flex flex-col gap-6 sm:gap-8">
          {/* Display title, hairline below — same pattern as home/about.
              Lines rise out from behind their masks; the red period stamps in
              last; the hairline draws itself left to right once it's in view.
              The title recedes on scroll like every other hero. */}
          <section>
          ...
          {/* Copy + decoration | form, split by a vertical hairline. Flowed as
              one block rather than per column: melting the form on its own
              schedule would fade fields out from under someone filling them. */}
          <div data-flow className="grid grid-cols-1 md:grid-cols-2">
