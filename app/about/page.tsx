          ...
          <section className="w-full sys-panel p-4 sm:p-7 flex flex-col gap-5 sm:gap-6">
            ...
            <div className="space-y-4 sm:space-y-6 text-muted-foreground">
              <p className="text-sm sm:text-base">
                I&apos;m a staff product designer and founder with <span className="text-foreground font-medium">8 years of experience</span> shipping B2B products at early-stage startups in healthcare, cybersecurity, and finance.
              </p>
              <p className="text-sm sm:text-base">
