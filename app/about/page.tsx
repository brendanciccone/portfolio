          ...
          <section className="w-full sys-panel p-4 sm:p-7 flex flex-col">
            ...
            <div className="space-y-4 sm:space-y-6 text-muted-foreground">
              <p className="text-sm sm:text-base">
                I&apos;m a staff product designer with <span className="text-foreground font-medium">8 years of experience</span> shipping API-driven B2B products across fintech, cybersecurity, and healthcare. I specialize in replacing manual, paper-heavy workflows with software that scales.
              </p>
              <p className="text-sm sm:text-base">
                I founded Paidly in 2020, an API-driven invoicing platform built on Stripe and used by <span className="text-foreground font-medium">over 2,000 SMEs</span> processing <span className="text-foreground font-medium">$500K+ in volume</span>. I owned the full stack of product decisions: payment infrastructure, compliance flows, and the end-user experience. At Corellium, I owned end-to-end product design for automated compliance and security workflows, shipped CI/CD-integrated tools, and achieved an 81 SUS score that contributed to a <span className="text-foreground font-medium">$200M acquisition</span> by Cellebrite.
              </p>
              <p className="text-sm sm:text-base">
                As founding product designer at Immertec, I built the design system from day one, led a HIPAA-compliant platform redesign that <span className="text-foreground font-medium">increased SUS from 68 to 83</span>, hired and managed 2 product designers, and helped secure <span className="text-foreground font-medium">$12M in Series A</span> funding. In 2023 I started Magier, an AI startup that was <span className="text-foreground font-medium">acquired the same year</span> and accepted into <span className="text-foreground font-medium">Techstars&apos; 2024</span> cohort. In late 2025, I built Crenel and was <span className="text-foreground font-medium">selected for Coinbase&apos;s accelerator</span> (50 of 900+ applicants).
              </p>
              <p className="text-sm sm:text-base">
