        ...
        <FadeIn delay={100} duration={350}>
          <section>
            ...
            <div className="space-y-4 text-muted-foreground mb-6">
              ...
              <p>
                I pushed for this redesign for <span className="text-foreground font-medium">over a year</span>. It kept getting deprioritized in favor of customer-specific requests, which made sense given they directly impacted revenue. The window opened when a PM's roadmap had capacity and I could show how the fix would solve pain points for his user segment, a group directly tied to company revenue. I presented first to him and the head of front-end engineering to get buy-in, then shared it with the wider product team. Persistence mattered as much as the solution.
              </p>
            </div>
          </section>
        </FadeIn>
